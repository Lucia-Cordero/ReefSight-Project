...
def preproc(X):
    ...
    preproc_save_path = os.path.join(os.path.expanduser('~'), "code", "Lucia-Cordero", "08-ReefSight", "models")
...
def load_preproc():
    ...
    preproc_path = os.path.join(os.path.expanduser('~'), "code", "Lucia-Cordero", "08-ReefSight", "models")
...
def preprocess() -> None:
    ...
    data_raw_path = os.path.join(os.path.expanduser('~'), "code", "Lucia-Cordero", "08-ReefSight", "tabular_data", "raw", "global_bleaching_environmental_raw.csv")
    data_processed_path = os.path.join(os.path.expanduser('~'), "code", "Lucia-Cordero", "08-ReefSight", "tabular_data", "processed", "global_bleaching_environmental_processed.csv")
